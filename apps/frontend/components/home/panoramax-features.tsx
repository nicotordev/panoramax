...
export default function PanoramaxFeatures({
  ...
  return (
    <section className="border-b border-border/40 bg-primary/10 py-16 text-foreground lg:py-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-6 lg:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <Badge
              variant="outline"
              className="mb-3 rounded-full border-primary/20 bg-background/80 text-primary backdrop-blur-sm hover:bg-background/80"
            >
              {messages.badge}
            </Badge>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <Card
                key={feature.title}
                className="border-primary/20 bg-background/80 py-0 backdrop-blur-sm"
              >
                <div className="p-6">
